...
def parse_args(args):
    ...
    #csv_parser.add_argument('annotations', help='Path to CSV file containing annotations for training.', default='./dataset/train.csv')
    #csv_parser.add_argument('classes', help='Path to a CSV file containing class label mapping.', default='./dataset/classes.csv')
    #csv_parser.add_argument('--val-annotations', help='Path to CSV file containing annotations for validation (optional).', default='./dataset/test.csv')
